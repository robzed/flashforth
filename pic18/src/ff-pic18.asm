...
PRAM        equ RAM_LO      ; h'f000'
PEEPROM     equ EEPROM_LO   ; h'ec00'
...
irq_ms:
        ...
        banksel load_res
        movf    load_acc, W
        movwf   load_res, BANKED
        movf    load_acc+1, W
        movwf   load_res+1, BANKED
        movf    load_acc+2, W
        movwf   load_res+2, BANKED
        clrf    load_acc, A
        clrf    load_acc+1, A
        clrf    load_acc+2, A
#endif
...
WARMLIT:
        ...
        dw      utibbuf+(PRAM+1); TIB (one extra byte for WORD)
        dw      0              ; ustatus & uflg
        dw      0,0,0,0
...
LOAD:
        banksel load_res
        movf    load_res, W, BANKED
        movwf   plusS, A
        movf    load_res+1, W, BANKED
        movwf   plusS, A
        movf    load_res+2, W, BANKED
        movwf   plusS, A
        clrf    plusS, A
        call    LIT
        dw      CPU_LOAD_VAL
...
L_LI:
        ...
        movf    PRODL, W, A
        banksel ihprodl
        movwf   ihprodl, BANKED
        movf    PRODH, W, A
        movwf   ihprodh, BANKED
        movf    TBLPTRL, W, A
        movwf   ihtblptrl, BANKED
        movf    TBLPTRH, W, A
        movwf   ihtblptrh, BANKED
        movf    TABLAT, W, A
        movwf   ihtablat, BANKED
        movf    Sp, W, A
        movwf   ihsp, BANKED
        movf    Sbank, W, A
        movwf   ihsbank, BANKED 
...
L_IR:
        db      NFA|INLINE|COMPILE|2,"i]"
        banksel ihsbank
        movf    ihsbank, W, BANKED
        movwf   Sbank, A
        movf    ihsp, W, BANKED
        movwf   Sp, A
        movf    ihtablat, W, BANKED
        movwf   TABLAT, A
        movf    ihtblptrl, W, BANKED
        movwf   TBLPTRL, A
        movf    ihtblptrh, W, BANKED
        movwf   TBLPTRH, A
        movf    ihprodl, W, BANKED
        movwf   PRODL, A
        movf    ihprodh, W, BANKED
        movwf   PRODH, A
        return
...
VER:
        ...
        db d'38'," FlashForth 5 ",PICTYPE," 19.01.2019\r\n"
        goto    TYPE
;*******************************************************
ISTORECHK:
#if XSTORE == ENABLE
